...
from data_driven_functional_connectivity.model import NodeRNN, NodeConv, init_param
...
# Model and optimizer
model = NodeRNN(data.size(2), [data.size(1), 20], args.hidden, 1, args.kernel_size, args.dropout)
# model = NodeConv([data.size(1), 50, 40, 20, 10, 5, 1], kernel_size=2)
